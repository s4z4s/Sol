...
def chatbot():
    ...
    print("Hi, I'm Sol. How can I help you today?")
    ...
    while True:
        ...
        if user_input in data:
            ...
            if previous_question:
                print(f"\nSol: Can you please provide more context and clarify what you mean by 'why' or 'how' regarding the question '{previous_question}'?")
            else:
                print("\nSol: I'm sorry, I don't have enough information to answer that question.")
        else:
            ...
            if closest_question:
                ...
                answer = input("\nSol: I'm sorry, I don't understand. Can you provide an answer for that question? (y/n) ")
                if answer == "y":
                    new_answer = input("\nWhat is the answer? ")
